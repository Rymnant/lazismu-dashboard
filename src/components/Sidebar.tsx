...
const sidebarItems = [
  ...
  { name: 'History', icon: 'M12 14l9-5-9-5-9 5 9 5z', href: '/history' },
  { name: 'Live Chat', icon: "M12 14l9-5-9-5-9 5 9 5z", href: "/chat" },
  { name: 'Konten', icon: 'M12 14l9-5-9-5-9 5 9 5z', href: '/content' },
  { name: 'Feedback', icon: 'M12 14l9-5-9-5-9 5 9 5z', href: '/feedback' },
  { name: 'Kelola Promo', icon: 'M12 14l9-5-9-5-9 5 9 5z', href: '/promo' },
]
